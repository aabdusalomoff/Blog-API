...
from .serializers import (SignUpSerializer, TagSerializer, 
                          ArticleSerializer, CommentSerializer, 
                          ArticleReactionSerializer, FollowSerializer, 
                          ProfileSerializer, ArticleViewSerializer,
...
class FeedApiView(APIView):
    ...
    @extend_schema(
        ...
        description="Retrieves a list of articles based on user authentication or Anonymous-ID.",
        parameters=[
            OpenApiParameter(
                name="Anonymous-ID",
