# Generated by Django 4.2.27 on 2026-01-11 17:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reaction', models.CharField(choices=[('like', 'LIKE'), ('dislike', 'DISLIKE')], max_length=255)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AddField(
            model_name='article',
            name='tags',
            field=models.ManyToManyField(related_name='articles', to='main.tag'),
        ),
    ]
